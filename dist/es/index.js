...
var Dropzone = function (_React$Component) {
  ...
  _createClass(Dropzone, [{
    ...
    value: function onDragEnter(evt) {
      ...
      var _getDataTransferItems = getDataTransferItems(evt),
          files = _getDataTransferItems.files,
          isFiles = _getDataTransferItems.isFiles;
    ...
    value: function onDrop(evt) {
      ...
      getDroppedOrSelectedFiles(evt).then(function (fileList) {
        var acceptedFiles = [];
        var rejectedFiles = [];
        fileList.forEach(function (fileWrap) {
          var file = fileWrap.fileObject;
          if (!disablePreview) {
            try {
